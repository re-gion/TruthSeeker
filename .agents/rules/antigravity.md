...
This file provides guidance to Antigravity (Google's AI IDE) when working with code in this repository.

(antigravity.md holds the rules for the Antigravity project, while CLAUDE.md is for Claude Code. As Google's Antigravity, please refer only to antigravity.md. Both files contain the exact same information.)
