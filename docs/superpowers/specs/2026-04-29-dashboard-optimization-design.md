...
> **状态：历史设计稿。** 本文件保留当时的数据大屏设计目标，不代表当前页面、接口或指标已经全部实现；当前事实以源码、根 `README.md` 和 `docs/FRONTEND_GUIDELINES.md` 为准。
...
6. 生成图片/视频 · 31.0% · "直接使用AI生成多媒体内容的用户占比，与 AIGC 伪造风险直接相关"
...
2. 短视频用户 · 10.40 亿人 · "使用率 93.8%，AIGC 伪造内容主要扩散场"
